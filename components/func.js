export default {
    'func':{
        ...
        'total': {
            'caption':'10,20,30...というようにカンマで区切った数字を計算します。',
            'function':'(...param)=>{ let re = 0; for (let i in param) {re += param[i]*1;} return re;}'
        },
        'factorial': {
            'caption':'ゼロから入力値までの合計を計算します。',
            'function':'(...param)=>{ let re = 0; for (let i=0;i<=param[0];i++) {re += i;} return re;}'
        },
    }
}